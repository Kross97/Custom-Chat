...
export default () => {
  ...
  return (
    <>
      <div aria-hidden onClick={showFormAddUser} className={addUserStyle.blockBackground} role="button" aria-label="Show" />
      <form onSubmit={addUser} className={addUserStyle.formAddUser}>
        ...
        <div className={addUserStyle.dataForm}>
          <div className={addUserStyle.dataInputs}>
            <input onChange={changeName} type="text" placeholder="Enter your name" value={name} />
