...
export const ListUsers = () => {
  ...
  const allUsersAfterSearch = allUsersAfterSorting.length !== 0 && allUsersAfterSorting.map(
    (user) => (
  ...
  const allMessagesAfterSearch = allUsersAfterSorting.length !== 0 && allUsersAfterSorting.map(
    (user) => {
